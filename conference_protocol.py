...
SEU Meeting 扩展了JSON控制协议，支持多方聊天室控制、
音频传输元数据和客户端质量反馈。
"""
...
def encode_avatar_upload(username: str, avatar_data: bytes) -> str:
    msg = {
        "type": "avatar_upload",
        "username": username,
...
def encode_avatar_download(username: str, target_user: str = "") -> str:
    msg = {
...
def encode_avatar_sync(username: str, avatar_data: bytes) -> str:
    msg = {
        "type": "avatar_sync",
        "username": username,
        "data": base64.b64encode(avatar_data).decode("utf-8"),
