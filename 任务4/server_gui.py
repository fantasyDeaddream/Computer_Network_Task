...
from telephone_server import TelephoneServer


class ServerGUI(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("任务4 - IP电话系统服务器")
        ...
        self._server: TelephoneServer | None = None
    ...
    def _build_ui(self) -> None:
        ...
        hint = "说明：本窗口启动的是任务4实现的IP电话系统服务器。"
    ...
    def _on_start(self) -> None:
        ...
        port = int(self.port_var.get() or 8881)

        def spawn() -> None:
            try:
                self._server = TelephoneServer(port=port)
