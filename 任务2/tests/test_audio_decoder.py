...
class TestAudioDecoder:
    ...
    def test_normalize_wav_from_stereo_8k(self):
        """测试自适应转换不同参数的WAV文件"""
        audio_data = b"\x00\x00\x10\x00" * 400
        wav_data = AudioEncoder.encode_to_wav(
            audio_data,
            sample_rate=8000,
            channels=2,
        ...
        normalized_frames, sample_rate, channels, sample_width = AudioDecoder.normalize_wav(
            wav_data
        )
