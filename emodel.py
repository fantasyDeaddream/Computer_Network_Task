"""
ITU-T G.107 E-model 语音质量评估助手。

完整的建议书包含许多电话参数。本项目使用常用的VoIP规划子集：

    R = Ro - Is - Id - Ie_eff + A

延迟、抖动和丢包从音频帧测量，然后转换为R因子和窄带MOS估计值。
"""
